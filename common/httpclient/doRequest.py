...
class DoRequest(object):
    ...
    def post_with_form(self, path, params=None):
        r = self._session.post(self._url + path, data=params, headers=self._headers, cookies=self._cookies,
    ...
    def getFile(self, path, storeFilePath, params=None):
        ...
        :return:
        """
        r = requests.get(self._url + path, params=params, headers=self._headers, cookies=self._cookies,
                         timeout=self._timeout,
                         proxies=self._proxies)
